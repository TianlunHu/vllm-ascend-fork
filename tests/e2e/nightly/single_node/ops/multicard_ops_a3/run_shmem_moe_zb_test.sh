...
export VLLM_ASCEND_MOE_MC2_TEST_NUM_WARMUPS="${VLLM_ASCEND_MOE_MC2_TEST_NUM_WARMUPS:-${VLLM_ASCEND_ZB_TEST_NUM_WARMUPS:-10}}"
export VLLM_ASCEND_MOE_MC2_TEST_NUM_TESTS="${VLLM_ASCEND_MOE_MC2_TEST_NUM_TESTS:-${VLLM_ASCEND_ZB_TEST_NUM_TESTS:-100}}"
export VLLM_ASCEND_MOE_MC2_TEST_NUM_PROFILE_TESTS="${VLLM_ASCEND_MOE_MC2_TEST_NUM_PROFILE_TESTS:-${VLLM_ASCEND_ZB_TEST_NUM_PROFILE_TESTS:-30}}"
