...
# Small defaults for a quick smoke test; override as needed.
export VLLM_ASCEND_MOE_MC2_TEST_WORLD_SIZE="${VLLM_ASCEND_MOE_MC2_TEST_WORLD_SIZE:-2}"
export VLLM_ASCEND_MOE_MC2_TEST_NUM_TOKENS="${VLLM_ASCEND_MOE_MC2_TEST_NUM_TOKENS:-8}"
export VLLM_ASCEND_MOE_MC2_TEST_HIDDEN="${VLLM_ASCEND_MOE_MC2_TEST_HIDDEN:-128}"
export VLLM_ASCEND_MOE_MC2_TEST_NUM_TOPK="${VLLM_ASCEND_MOE_MC2_TEST_NUM_TOPK:-4}"
export VLLM_ASCEND_MOE_MC2_TEST_NUM_EXPERTS="${VLLM_ASCEND_MOE_MC2_TEST_NUM_EXPERTS:-4}"
