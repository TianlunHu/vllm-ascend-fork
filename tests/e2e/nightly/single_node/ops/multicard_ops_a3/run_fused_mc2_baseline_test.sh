...
export VLLM_ASCEND_FUSED_MC2_TEST_NUM_WARMUPS="${VLLM_ASCEND_FUSED_MC2_TEST_NUM_WARMUPS:-${VLLM_ASCEND_MOE_MC2_TEST_NUM_WARMUPS}}"
export VLLM_ASCEND_FUSED_MC2_TEST_NUM_TESTS="${VLLM_ASCEND_FUSED_MC2_TEST_NUM_TESTS:-${VLLM_ASCEND_MOE_MC2_TEST_NUM_TESTS}}"
export VLLM_ASCEND_FUSED_MC2_TEST_NUM_PROFILE_TESTS="${VLLM_ASCEND_FUSED_MC2_TEST_NUM_PROFILE_TESTS:-${VLLM_ASCEND_ZB_TEST_NUM_PROFILE_TESTS:-${VLLM_ASCEND_MOE_MC2_TEST_NUM_TESTS}}}"
