...
/* function: aclnnShmemMoeDistributeDispatchZeroBufferGetWorkspaceSize
 * parameters :
 * x : required
 * expertIds : required
 ...
 */
__attribute__((visibility("default"))) aclnnStatus aclnnShmemMoeDistributeDispatchZeroBufferGetWorkspaceSize(
...
/* function: aclnnShmemMoeDistributeDispatchZeroBuffer
 * parameters :
 ...
 * stream : acl stream.
 */
__attribute__((visibility("default"))) aclnnStatus aclnnShmemMoeDistributeDispatchZeroBuffer(void *workspace,
