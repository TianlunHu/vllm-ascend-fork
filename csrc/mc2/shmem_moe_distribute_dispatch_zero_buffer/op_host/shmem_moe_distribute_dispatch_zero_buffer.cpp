...
namespace ops {
class ShmemMoeDistributeDispatchZeroBuffer : public OpDef
{
public:
    explicit ShmemMoeDistributeDispatchZeroBuffer(const char *name) : OpDef(name)
    {
        this->Input("x")
            .ParamType(REQUIRED)
...
OP_ADD(ShmemMoeDistributeDispatchZeroBuffer);
