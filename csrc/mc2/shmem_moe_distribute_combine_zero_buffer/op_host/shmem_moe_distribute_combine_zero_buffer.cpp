...
namespace ops {
class ShmemMoeDistributeCombineZeroBuffer : public OpDef
{
public:
    explicit ShmemMoeDistributeCombineZeroBuffer(const char *name) : OpDef(name)
    {
        this->Input("expand_x")
            .ParamType(REQUIRED)
...
OP_ADD(ShmemMoeDistributeCombineZeroBuffer);
