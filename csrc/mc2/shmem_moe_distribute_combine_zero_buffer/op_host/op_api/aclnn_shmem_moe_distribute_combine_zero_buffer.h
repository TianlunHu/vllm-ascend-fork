...
/* function: aclnnShmemMoeDistributeCombineZeroBufferGetWorkspaceSize
 * parameters :
 * expandX : required
 * expertIds : required
 ...
 */
__attribute__((visibility("default"))) aclnnStatus aclnnShmemMoeDistributeCombineZeroBufferGetWorkspaceSize(
...
/* function: aclnnShmemMoeDistributeCombineZeroBuffer
 * parameters :
 ...
 * stream : acl stream.
 */
__attribute__((visibility("default"))) aclnnStatus aclnnShmemMoeDistributeCombineZeroBuffer(void *workspace,
