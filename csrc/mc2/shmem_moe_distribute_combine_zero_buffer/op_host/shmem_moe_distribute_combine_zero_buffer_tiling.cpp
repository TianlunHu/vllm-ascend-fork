 ...
 * Description: ShmemMoeDistributeCombineZeroBuffer tiling function implementation file
 * History: 2025-12-16 create ShmemMoeDistributeCombineZeroBuffer tiling function implementation file
 */
#include <queue>
#include <vector>
#include <dlfcn.h>
...
#include "../op_kernel/shmem_moe_distribute_combine_zero_buffer_tiling.h"
...
const char *K_INNER_DEBUG = "ShmemMoeDistributeCombineZeroBuffer Tiling Debug";
...
// a3专有
static void PrintTilingDataInfo(const char *nodeName, ShmemMoeDistributeCombineZeroBufferTilingData &tilingData)
{
...
static ge::graphStatus GetAttrAndSetTilingData(const gert::TilingContext *context,
                                               ShmemMoeDistributeCombineZeroBufferTilingData &tilingData, const char *nodeName,
...
static bool CheckTensorShape(const gert::TilingContext *context, ShmemMoeDistributeCombineZeroBufferTilingData &tilingData,
...
static bool CheckSharedAttrs(const char *nodeName, const ShmemMoeDistributeCombineZeroBufferTilingData &tilingData)
{
    uint32_t sharedExpertNum = tilingData.moeDistributeCombineV2Info.sharedExpertNum;
    uint32_t sharedExpertRankNum = tilingData.moeDistributeCombineV2Info.sharedExpertRankNum;
...
static bool CheckAttrs(const gert::TilingContext *context, ShmemMoeDistributeCombineZeroBufferTilingData &tilingData,
...
static void SetHCommCfg(const gert::TilingContext *context, ShmemMoeDistributeCombineZeroBufferTilingData *tiling,
...
static ge::graphStatus MoeDistributeCombineA3TilingFuncImpl(gert::TilingContext *context)
{
    ...
    ShmemMoeDistributeCombineZeroBufferTilingData *tilingData = context->GetTilingData<ShmemMoeDistributeCombineZeroBufferTilingData>();
...
static ge::graphStatus ShmemMoeDistributeCombineZeroBufferTilingFunc(gert::TilingContext *context)
{
...
ge::graphStatus TilingParseForShmemMoeDistributeCombineZeroBuffer(gert::TilingParseContext *context)
{
    (void)context;
    return ge::GRAPH_SUCCESS;
}

IMPL_OP_OPTILING(ShmemMoeDistributeCombineZeroBuffer)
    .Tiling(ShmemMoeDistributeCombineZeroBufferTilingFunc)
    .TilingParse<MoeDistributeCombineCompileInfo>(TilingParseForShmemMoeDistributeCombineZeroBuffer);
}  // namespace optiling
